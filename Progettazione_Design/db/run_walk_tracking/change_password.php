<?php
  ...
  try{
      ...
      die(json_errors("Il link per la reimpostazione che hai cliccato è SCADUTO!! Per favore richiedene uno nuovo."));
  }catch(Exception $e){
  ...
  <body>
    ...
    <div class="container-fluid">
        <div class="bg-faded px-4 py-3 my-3 mx-5">
          <div class="text-center">
            <h1 class="card-title d-inline-flex">Reimposta password </h1>
          </div>
                ...
                <div class="fields-for-password">
                  <div class="form-group">
                    ...
                    <div class="class-new-password">
                      <input id="username" class="form-control" type="text" name="username" placeholder="inserisci" required>
                      <span class="feedback"></span>
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="control-label" for="new-password">Nuova Password</label>
                    <div class="class-new-password">
                      <input id="new-password" class="form-control" type="password" name="password" placeholder="inserisci" required>
                      <span class="feedback"></span>
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="control-label" for="conf-new-password">Conferma Password</label>
                    <div class="class-conf-password">
                      <input id="conf-new-password" class="form-control" type="password" name="conf-password" placeholder="inserisci" required>
                      <span class="feedback"></span>
                    </div>
                  </div>
                  ...
                  <div class="form-group text-center">
                      <button class="btn" name='change_password' type="button">Cambia</button>
                  </div>
    ...
    <script>
      function error(error){
        ...
        $("div.alert-container").append('<div class="alert alert-danger" role="alert">'+error+'</div>');
      }

      function success(success){
        $("div.alert-container").empty();
        $("div.alert-container").append('<div class="alert alert-success" role="alert">'+success+'</div>');
      }
