...
--
-- Database: `runwalktracking`
--
CREATE DATABASE IF NOT EXISTS `runwalktracking` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `runwalktracking`;
...
ALTER TABLE `login`
  ...
  ADD UNIQUE KEY `SID_Login_ID` (`username`),
