...
public class ActionReceiver{
    ...
    public static final String TIMER_ACTION = "duration";
    public static final String DISTANCE_ENERGY_ACTION = "distance_energy";
    public static final String DRAWING_MAP_TIMER_ACTION = "map_drawing";
