...
public class MeasureClassTest {
    ...
    public void test(){
        ...
        Assert.assertEquals(com.run_walk_tracking_gps.gui.enumeration.Measure.DISTANCE, measure.getType());
        Assert.assertEquals(MeasureUnit.KILOMETER, measure.getUnit());


        Assert.assertNull(measure.conversionTo(MeasureUnit.FEET));
